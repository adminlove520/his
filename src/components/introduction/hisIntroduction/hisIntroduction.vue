<template>
  <div class="hisIntroduction">
    <el-tabs v-model="activeName" @tab-click="handleClick">
      ...
      <p style="line-height:30px"><em style="font-size:24px">**医院</em>是一家集医疗、教学、科研、预防、保健为一体的非营利性综合二级甲等医院，医院始建于2017年，位于广州市的东面，是广州市著名的公立医院之一，承担市内几十万到几百万人口的医疗、保健、疾病防治任务，是广东省高等医学院教学医院，其影响辐射到整个广州市以及周边地区。
